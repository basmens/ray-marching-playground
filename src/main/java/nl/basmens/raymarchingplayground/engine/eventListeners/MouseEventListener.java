...
public class MouseEventListener {
  private static MouseEventListener instance = null;
  ...
  public static boolean isButtonPressed(int button) {
    if (button < get().buttonsPressed.length) {
      ...
      throw new InvalidParameterException("Button number " + button + " doesn't exist. Maximum button number is " + (get().buttonsPressed.length - 1));
    }
  }
}
